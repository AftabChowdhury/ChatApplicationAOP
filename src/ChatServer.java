...
public class ChatServer extends UnicastRemoteObject implements ChatServerIF {
	...
	public void updateChat(String name, String nextPost) throws RemoteException {
		//name = ClientRMIGUI.encryptMethod(name);
		//String message =  name + " : " + nextPost + "\n";
		sendToAll( name, nextPost);
	}
	 ...
	 * @param newMessage
	 */
	public void sendToAll(String name, String newMessage){
		newMessage = ClientRMIGUI.encryptMethod(newMessage);
		...
		String msgSound = "/src/Message.au";
		ChatClient3.notifySound(msgSound);
	}
	 ...
	 */
	@Override
	public void sendPM(int[] privateGroup, String messageHead, String privateMessage) throws RemoteException{
		Chatter pc;
		privateMessage = ClientRMIGUI.encryptMethod(privateMessage);
		privateMessage = messageHead + " " + privateMessage;	
