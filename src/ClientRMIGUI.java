...
public class ClientRMIGUI extends JFrame implements ActionListener{
	...
	public ClientRMIGUI(){
		...
		frame.addWindowListener(new java.awt.event.WindowAdapter() {
		    ...
		    public void windowClosing(java.awt.event.WindowEvent windowEvent) {
		    	...
		    	if(chatClient != null){
			    	try {
			    		message = encryptMethod("Bye all, I am leaving");
			        	sendMessage(message);			        	
	...
	public void actionPerformed(ActionEvent e){
		...
		try {
			...
			if(e.getSource() == privateMsgButton){
				...
				message = objectSpamFilterAll.spamFilter(message);
				message = encryptMethod(message);
				String messageHead = "[PM from " + name + "] :";				
				sendPrivate(privateList, messageHead, message);
				saveinLogFile(message);
				System.out.println("Sending message : " + message);
			}
			//verify password
	 ...
	 * @throws RemoteException
	 */
	private void sendPrivate(int[] privateList,String messageHead,String message) throws RemoteException {
		String privateMessage = message + "\n";
		chatClient.serverIF.sendPM(privateList, messageHead, privateMessage);
	}
	...
	/* Implement ROT13 for encryption*/
	 ...
	 /* Implement Exchange 2 letter for encryption*/
	 public static String encryptMethod(String value) {
	 ...
	 public void saveinLogFile(String message) {
		////create log file/////////
		    ...
		    try {  
		        ...
		        // the following statement is used to log any messages
		        messageToLog = encryptMethod(message);
		        messageToLog = name + " : " + messageToLog + "\n";
		        logger.info(messageToLog);  
